//https://teachablemachine.withgoogle.com/models/aHKL7FLE0/
Webcam.set({
    width:350,
    height:300,
    image_format:"jpg",
...
classifier=ml5.imageClassifier("https://teachablemachine.withgoogle.com/models/aHKL7FLE0/model.json", modelLoaded);
